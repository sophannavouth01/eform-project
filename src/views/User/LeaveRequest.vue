		...
		<div
		  ...
		  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
			...
			<div>
			  ...
			  <n-select v-model:value="employeeId" filterable placeholder="Search Employees" :options="options"  :loading="loading" clearable remote @search="handleSearch" @update:value="onEmployeeChange"  class="mt-3" />
			</div>
