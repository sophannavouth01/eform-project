		...
		<form @submit.prevent="submitForm">
			...
			<div
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
					...
					<!-- desination location Requested -->
					<div>
						<label for="desination-location" class="pt-2 text-[16px]">Desination / <span
								class="battambang-regular text-[16px]">ទីតាំងដែលត្រូវចុះបេសកម្ម</span></label>
						<n-input v-model:value="form.desinationlocation" type="text" class="mt-3" />
					</div>
					<!-- Reason for Leave -->
					<div>
					...
					<div>
						...
						<n-upload class="mt-3"  v-model:value="form.Attachements" directory-dnd :max="1"
                            ...
                            :show-file-list="true" :key="uploadKey" :on-error="handleUploadError">
                            <n-upload-dragger>
...
const uploadKey = ref(Date.now()); // Add a reactive key for the n-upload component
